    ...
    const gameData = [
        {
            ...
            games: [
                { title: "Kid Konstitution", description: "A fun and easy quiz game for learning the basics of your rights.", url: "games/kid-konstitution.html", icon: "fas fa-child text-blue-400" },
                { title: "Constitution Quest", description: "An epic text-based adventure to find the 10 lost scrolls of the Bill of Rights.", url: "games/constitution-quest.html", icon: "fas fa-scroll text-yellow-400" },
                { title: "Law & Layers Quest", description: "Categorize legal concepts into the Constitution, Legislation, or Common Law.", url: "games/law-layers-quest.html", icon: "fas fa-layer-group text-indigo-400" },
                { title: "Rights Racer", description: "A fast-paced arcade game where you race to collect rights and avoid obstacles.", url: "games/rights-racer.html", icon: "fas fa-flag-checkered text-green-400" },
                { title: "Mythbuster", description: "Test your knowledge by separating legal facts from common myths.", url: "games/mythbuster-game.html", icon: "fas fa-ghost text-teal-400" },
            ]
        },
        {
            ...
            games: [
                { title: "Constitution Defender", description: "Defend the pillars of justice from bugs of corruption in this arcade shooter.", url: "games/constitution-defender.html", icon: "fas fa-rocket text-purple-400" },
                { title: "Constitution Champions", description: "A timed quiz challenge to see how long you can defend your knowledge.", url: "games/constitution-champions.html", icon: "fas fa-trophy text-yellow-400" },
                { title: "Constitution Crusaders", description: "Conquer all 9 provinces in a map-based quiz to unite the nation.", url: "games/constitution-crusaders.html", icon: "fas fa-map-marked-alt text-orange-400" },
                { title: "Goliath's Reckoning", description: "Face the Goliaths of our time in a story-driven battle of wits and legal knowledge.", url: "games/goliaths-reckoning.html", icon: "fas fa-fist-raised text-red-500" },
                { title: "Justice Builder", description: "A simulation where you build a legal case from scratch, making critical decisions.", url: "games/justice-builder.html", icon: "fas fa-gavel text-gray-400" },
                { title: "Legal Simulator", description: "A branching narrative game where your choices determine your success as a lawyer.", url: "games/legal-simulator.html", icon: "fas fa-briefcase text-cyan-400" },
            ]
        },
        {
            ...
            games: [
                { title: "Cultural Dress-Up Adventure", description: "Learn about traditional attire in this drag-and-drop game.", url: "games/cultural-dress-up.html", icon: "fas fa-tshirt text-pink-400" },
                { title: "Ancestor's Quest", description: "A point-and-click adventure to gather items for a traditional ceremony.", url: "games/ancestors-quest.html", icon: "fas fa-map-signs text-green-400" },
                { title: "My Family, My Clan", description: "Build an interactive family tree and learn about your Xhosa lineage.", url: "games/my-family-my-clan.html", icon: "fas fa-users text-blue-400" },
                { title: "Customs & Consequences", description: "A scenario-based game to test your decision-making in traditional contexts.", url: "games/customs-consequences.html", icon: "fas fa-balance-scale-right text-purple-400" },
                { title: "The System: A Satirical Game", description: "A text-based satirical adventure poking fun at the legal system.", url: "games/satirical-game.html", icon: "fas fa-theater-masks text-gray-500" },
            ]
        }
    ];
